...
import { AddRoomsByRange, BookingStatus, listBookedRoomsWithGuests, listRoomTypes, loginAdmin, listBookingRequests, getSingleGuest,
  deleteGuest, AddRoomType, submitComplaint, getAllComplaints, getDailyDemand, getMockDemand   } from "../controller/adminController.js"
...
adminRouter.get("/daily-demand", getDailyDemand);
adminRouter.get("/mock-demand", getMockDemand);
