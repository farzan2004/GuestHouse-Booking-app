...
const Footer = () => {
    return (
        <div className='bg-[#303131] w-full min-h-[200px] md:h-[180px] flex flex-col md:flex-row justify-between items-start md:items-center px-6 md:px-16 md:py-8 py-2 text-white'>
            ...
            <img src="/Birla_Institute_of_Technology_Mesra_log.png" alt="bit_logo" className="h-16 w-16 top-0 left-0 bg-transparent" />
                <h3 className='text-lg md:text-xl font-bold font-cinzel'>BITStay</h3>
